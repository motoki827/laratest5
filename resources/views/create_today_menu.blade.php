                        ...
                        <div class="container mx-auto bg-gray-500 rounded-lg p-14">
                            ...
                            <form action="/search_result" method="post">
                                @csrf
                                    ...
                                    <div class="sm:flex items-center rounded-lg overflow-hidden px-2 py-1 justify-end">
                                            ...
                                            <table class="w-full divide-y divide-gray-200 table-fixed dark:divide-gray-700">
                                                ...
                                                <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                                                    <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                                        <td class="py-4 px-6 text-sm font-medium text-gray-900 whitespace-nowrap dark:text-white">{{$get['pra_name']}}</td>
                                                        <td class="py-4 px-6 text-sm font-medium text-gray-500 whitespace-nowrap dark:text-white">{{$get['pra_genre']}}</td>
                                                        <td class="overflow-hidden py-4 px-6 text-sm font-medium text-gray-900 whitespace-nowrap dark:text-white">{{$get['pra_content']}}</td>
